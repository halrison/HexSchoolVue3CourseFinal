<template>
  ...
  <div class="table-responsive-sm overflow-x-hidden" v-if="orders">
    ...
    <Modal size="lg" ref="ViewModal">
          <div class="modal-header">
            <h5 class="modal-title">訂單編號：{{ order.id }}</h5>
          </div>
    ...
    <Modal size="md" ref="PayModal">
        <FormC class="modal-content" v-slot="{ errors,values }" @submit="payOrder" @reset="$refs.PayModal.hideModal()" :validation-schema="schema()">
            <div class="modal-header">
                <h5>訂單編號：{{order.id }}</h5>
            </div>
            <div class="modal-body">
            ...
            <div class="col">
              <FieldC label="付款方式" class="form-select" name="method" as="select" v-bind:class="{'is-invalid': errors.method}" @change="changeSchema">
          ...
          <div v-if="values.method === 'credit-card'">
            <div class="row mt-1">
              <div class="col">發卡銀行</div>
              <div class="col">
                <FieldC label="此欄位" name="bank" class="form-control" type="text" as="input" v-bind:class="{ 'is-invalid': errors.bank }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="number" class="form-control" type="tel" as="input" v-bind:class="{ 'is-invalid': errors.number }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="owner" class="form-control" type="text" as="input" v-bind:class="{ 'is-invalid': errors.owner }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="expiry" class="form-control" type="date" as="input" v-bind:class="{ 'is-invalid': errors.expiry }" />
                <ErrorMessage name="expiry" class="invalid-feedback" />
              </div>
            </div>
            <div class="row mt-1">
              <div class="col">檢核碼</div>
              <div class="col">
                <FieldC label="此欄位" name="checksum" class="form-control" type="tel" as="input" v-bind:class="{ 'is-invalid': errors.checksum }" />
                <ErrorMessage name="checksum" class="invalid-feedback" />
              </div>
            </div>
          </div>
          <div v-else-if="values.method === 'bank-account'">
            <div class="row mt-1">
              <div class="col">開戶總行</div>
              <div class="col">
                <FieldC label="此欄位" name="headOffice" class="form-control" type="text" as="input" v-bind:class="{ 'is-invalid': errors.headOffice }" />
                <ErrorMessage name="headOffice" class="invalid-feedback" />
              </div>
            </div>
            <div class="row mt-1">
              <div class="col">開戶分行</div>
              <div class="col">
                <FieldC label="此欄位" name="branch" class="form-control" type="text" as="input" v-bind:class="{ 'is-invalid': errors.branch }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="account" class="form-control" type="tel" as="input" v-bind:class="{ 'is-invalid': errors.account }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="name" class="form-control" type="text" as="input" v-bind:class="{ 'is-invalid': errors.name }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="otp" class="form-control" type="tel" as="input" v-bind:class="{ 'is-invalid': errors.otp }" />
                <ErrorMessage name="otp" class="invalid-feedback" />
              </div>
            </div>
          </div>
          <div v-else-if="values.method === 'mobile-pay'">
            <div class="row mt-1">
              <div class="col">支付服務</div>
              <div class="col">
                <div class="form-check">
                  <FieldC label="此欄位" name="service" class="form-check-input" type="radio" as="input" value="linePay" v-bind:class="{ 'is-invalid': errors.service }" />
                  <label class="form-check-label">Line Pay</label>
                </div>
                <div class="form-check">
                  <FieldC label="此欄位" name="service" class="form-check-input" type="radio" as="input" value="applePay" v-bind:class="{ 'is-invalid': errors.service }" />
                  <label class="form-check-label">Apple Pay</label>
                </div>
                <div class="form-check">
                  <FieldC label="此欄位" name="service" class="form-check-input" type="radio" as="input" value="samsungPay" v-bind:class="{ 'is-invalid': errors.service }" />
                  <label class="form-check-label">Samsung Pay</label>
                </div>
                <div class="form-check">
                  <FieldC label="此欄位" name="service" class="form-check-input" type="radio" as="input" value="googlePay" v-bind:class="{ 'is-invalid': errors.service }" />
                  <label class="form-check-label">Google Pay</label>
                </div>
                <div class="form-check">
                  <FieldC label="此欄位" name="service" class="form-check-input" type="radio" as="input" value="jkopay" v-bind:class="{ 'is-invalid': errors.service }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="code" class="form-control" type="tel" as="input" v-bind:class="{ 'is-invalid': errors.code }" />
            ...
            <div class="row mt-1">
              ...
              <div class="col">
                <FieldC label="此欄位" name="password" class="form-control" type="password" as="input" v-bind:class="{ 'is-invalid': errors.password }" />
        ...
        switch(this.payOption){
            ...
            case 1:
                return {                    
                    ...
                    owner: 'required',
                    expiry: 'required',
                    checksum: 'required|integer|digit:3'
                }
            case 2:
                return {
                    headOffice: 'required',
